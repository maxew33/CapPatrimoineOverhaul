export default function page() {
    return (
        <main className="legal-notice-wrapper">
            <div className="legal-notice">
                <h3 className="centered">Mentions légales :</h3>
                <h3>
                    <span className="underlined">Définitions</span>
                </h3>
                <p>
                    <span className="underlined">Client : </span>tout
                ...
                <p>
                    ...
                    <a href="https://www.cabinet-cap-patrimoine.fr">
                        https://www.cabinet-cap-patrimoine.fr
                    </a>{' '}
                    met à disposition des Clients :
                </p>
                <p>
                    <span className="underlined">Contenu : </span>Ensemble des
                    éléments constituants l'information présente sur le Site,
                    notamment textes – images – vidéos.
                </p>
                <p>
                    <span className="underlined">Informations clients : </span>{' '}
                ...
                <p>
                    <span className="underlined">Utilisateur : </span>Internaute
                    se connectant, utilisant le site susnommé.
                </p>
                <p>
                    <span className="underlined">
                ...
                <p>
                    ...
                    <span>
                        SAS CV-FC gestion &amp; patrimoine - Capital social de
                        1000€ - Numéro de TVA: fr14907510499 - 13 allée du
                        carretey 33610 Cestas
                    </span>
                    <br />
                    <strong>Responsable publication : </strong>
                    <span>Vitu - cvconseilgestionpatrimoine@gmail.com </span>
                    <br />
                    ...
                    <span>Malfilâtre - maxime.malfilatre@gmail.com</span>
                    <br />
                </p>
                <p>
                ...
                <h6>
                    <span className="underlined">Sécurité</span>
                </h6>
                <p>
                ...
                <h5>
                    <span className="underlined">9.1. « COOKIES »</span>
                </h5>
                <p>
